...
impl Session {
    ...
    pub fn load(app: &App, name: &str, host: &str) -> CurveResult<Self> {
        let path = Session::path(app, name, host);
    ...
    pub fn save(&self, app: &App) -> CurveResult<()> {
    ...
    pub fn update_with_response(&mut self, resp: &reqwest::blocking::Response) {
